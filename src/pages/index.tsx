...
const IndexPage = ({ data, location: { pathname } }: PageProps): ReactElement => {
  ...
  useLayoutEffect(() => {
    dispatch({ type: SET_HEADER_VISIBILITY, headerIsVisible: false });
    ...
    return () => {
      dispatch({ type: SET_HEADER_VISIBILITY, headerIsVisible: true });
  ...
  }, [headerIsVisible, returnButtonIsVisible, footerIsVisible, dispatch]);
